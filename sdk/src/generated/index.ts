...
export type CommentSchema = Schema<'Comment'>;
export type CommentListSchema = Schema<'CommentList'>;
export type DocumentHistoryListSchema = Schema<'DocumentHistoryList'>;
