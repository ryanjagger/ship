 ...
 * opens the {@link FleetGraphChat} overlay drawer, seeded with the page's
 * entity context. NOT a route-agnostic global chatbot and NOT in nav.
 *
 * Availability (R18): when no AI provider is configured the control is HIDDEN
 * entirely (renders nothing) — never a dead disabled button.
 */
