...
| async-iterator pagination, typed discriminated error union, `webhooks` subscription client | **Planned** | land with refresh epic; subscriptions managed via raw `/api/v1/webhooks` today |
